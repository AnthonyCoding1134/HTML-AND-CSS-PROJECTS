...
// This function call displays the first image in the slideshow when the page loads
var slideIndex = 1;
...
function showSlides(n) {
    ...
    if (n < 1) {slideIndex = slides.length}; // If n (the number passed into the function) is less than 1, the slideIndex is set to highest slide# 
    for (i = 0; i < slides.length; i++) {
        slides[i].style.display = "none"; //all items in slides cant be seen at this point
     }
...
//This code will close the contact form when a user clicks off of it
